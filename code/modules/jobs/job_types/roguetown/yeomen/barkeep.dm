/datum/job/roguetown/barkeep
	...
	tutorial = "You are the hamlet’s innkeeper, providing hot meals and clean rooms for the many travelers arriving by boat.  See to all their needs; For coin, of course."
